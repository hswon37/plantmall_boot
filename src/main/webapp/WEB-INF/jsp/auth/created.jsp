...
<td style="width: 75%; text-align: center; height: 18px;">${userSession.user.userId}</td>
</tr>
<tr style="height: 18px;">
<td style="width: 25%; text-align: center; height: 18px;">NAME</td>
<td style="width: 75%; text-align: center; height: 18px;">${userSession.user.userName}</td>
</tr>
<tr style="height: 18px;">
<td style="width: 25%; text-align: center; height: 18px;">EMAIL</td>
<td style="width: 75%; text-align: center; height: 18px;">${userSession.user.email}</td>
</tr>
<tr style="height: 18px;">
<td style="width: 25%; text-align: center; height: 18px;">PHONE</td>
<td style="width: 75%; text-align: center; height: 18px;">${userSession.user.phone}</td>
</tr>
<tr style="height: 18px;">
<td style="width: 25%; text-align: center; height: 18px;">ZIPCODE</td>
<td style="width: 75%; text-align: center; height: 18px;">${userSession.user.zipcode}</td>
</tr>
<tr style="height: 18px;">
<td style="width: 25%; text-align: center; height: 18px;">ADDRESS</td>
<td style="width: 75%; text-align: center; height: 18px;">${userSession.user.address }</td>
</tr>
</tbody>
</table>
